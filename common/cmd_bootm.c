...
ulong load_addr = 0x80400000;	/* Default Load Address */ /// 0x80100000
...
int verify_kernel_image (ulong addr, ulong *pAddr, ulong *pData, ulong *pLen)
{
	...
	printf ("## Checking image at %08lx (%08lx) ...\n", addr,CFG_FLASH_BASE);
	...
	if (addr == 0x8A200000)
	   ...
	   ((void(*) (void)) (0x80100000U))();
	else if(addr == 0x80300000)
	   ((void(*) (void)) (0x80300000U))();
