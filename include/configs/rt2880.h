...
#if defined (MTK_NAND)
#define CFG_MALLOC_LEN      10*1024*1024
#else
...
#else
#define CFG_HTTP_DL_ADDR	0x80300000 /// 0x80300000
...
#define WEBFAILSAFE_UPLOAD_FACTORY_ADDRESS		CFG_FACTORY_ADDR
#define WEBFAILSAFE_UPLOAD_FACTORY_SIZE_IN_BYTES	CFG_FACTORY_SIZE
#define WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES	(CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE)
#define WEBFAILSAFE_UPLOAD_RAM_ADDRESS			0x80250000 //// load_addr
// httpd constants
